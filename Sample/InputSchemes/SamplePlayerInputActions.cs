...
//     version 1.14.0
//     from Assets/AppSDK/DingoLevelBasedInputSystem/Sample/InputSchemes/SamplePlayerInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/AppSDK/DingoLevelBasedInputSystem/Sample/InputSchemes/SamplePlayerInputActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @SamplePlayerInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @SamplePlayerInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""SamplePlayerInputActions"",
    ""maps"": [
        {
    ...
    ~@SamplePlayerInputActions()
    {
        UnityEngine.Debug.Assert(!m_MainInputActions.enabled, "This will cause a leak and performance issues, SamplePlayerInputActions.MainInputActions.Disable() has not been called.");
    }
    ...
    {
        private @SamplePlayerInputActions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MainInputActionsActions(@SamplePlayerInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
